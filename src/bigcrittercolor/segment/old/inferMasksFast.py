...
from bigcrittercolor.segment.fastsam import FastSAM, FastSAMPrompt

def inferMasksFast(img_ids, skip_existing=False, strategy="prompt1", text_prompt="subject", box_threshold=0.25, text_threshold=0.25,
    ...
    """
        ...
        :param str strategy: prepackaged strategies for creating masks from iNat images
            can be:
