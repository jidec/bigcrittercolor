...
# 2. load in segments (already filtered using clusterExtractSegs)
...
def inferMorphs(img_ids=None, group_records_colname ="species",
                cluster_params_dict={'algo':"gaussian_mixture",'find_n_minmax':(1,3),'find_n_metric':"aic"},
