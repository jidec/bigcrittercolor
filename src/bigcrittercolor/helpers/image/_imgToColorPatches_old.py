...
def _imgToColorPatches(img, input_colorspace="cielab", clahe=True, use_median=False, n_clusters=3, min_patch_pixels = 5, return_patch_masks_colors_imgshapes=False, show=False):
...
#img = _imgToColorPatches(img,show=True)