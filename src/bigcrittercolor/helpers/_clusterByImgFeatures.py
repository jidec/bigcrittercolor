...
def _clusterByImgFeatures(imgs, affprop_pref=-50,affprop_damping = 0.7, print_steps=True, show=False, show_n=10):

    # load model
    _bprint(print_steps,"Loading pretrained VGG16 feature extractor...")
