...
def create_collage(images, output_path, collage_width, h_overlap=0, v_overlap=0):
...
sorted_images = sort_images_by_hue(cv2_images_list)
create_collage(sorted_images, "output_collage.jpg", collage_width=100)
