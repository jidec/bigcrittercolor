...
filterExtractSegs(color_format_to_cluster = "grey", used_aux_segmodel=True,
    ...
    cluster_params_dict={'find_n_minmax':(3,4),'pca_n':5}, preselected_clusters_input = "1",
...
filterExtractSegs(color_format_to_cluster = "grey", used_aux_segmodel=True,
    ...
    feature_extractor="resnet18", # feature extractor
    cluster_algo="kmeans", cluster_n = 4,
    cluster_params_dict={'pca_n':5}, preselected_clusters_input = "1",
    show=True, show_indv=False, print_steps=True, data_folder="D:/anac_tests")
...
# finding n is slower, slowness should get worse with scale
