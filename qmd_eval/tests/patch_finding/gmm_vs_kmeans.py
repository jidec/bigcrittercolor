...
clusterColorsToPatterns(img_ids=None, cluster_individually=False, preclustered = False, group_cluster_records_colname = None,
                    by_patches=True, patch_args = {'min_patch_pixel_area':5,'cluster_args':{'n':4, 'algo':'kmeans'}}, visualize_patching=True,
                    colorspace = "rgb",
                    height_resize = 200,
...
# I think gmm is better? but hard to tell. theoretically this should be the case